...
class Privilege extends Base {
    ...
    public function index() {
        ...
        $data = \app\admin\model\Privilege::all();
    ...
    public function add() {
        ...
        $privilege = \app\admin\model\Privilege::create($request);
        if (!$privilege->id) {
    ...
    public function save() {
        ...
        if (!\app\admin\model\Privilege::update($request)) {
    ...
    public function del() {
        $id = $this->request->post("id");
        if (!\app\admin\model\Privilege::destroy($id)) {
